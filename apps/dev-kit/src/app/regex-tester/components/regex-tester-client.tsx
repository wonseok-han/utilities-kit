 ...
 * - 플래그 설정
 */
export function RegexTesterClient({ initialData }: RegexTesterClientProps) {
  const {
    clearAll,
    error,
    flags,
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            {initialData.samplePatterns.map((sample) => (
              <ActionButton
                key={sample.id}
                feedbackText="로드 완료"
                onClick={() => {
        ...
        <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            {initialData.sampleTestStrings.map((sample) => (
              <ActionButton
                key={sample.id}
                feedbackText="로드 완료"
